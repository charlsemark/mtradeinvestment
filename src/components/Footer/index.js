            ...
            <div className="mx-auto w-full px-10 py-18 lg:py-20">
                <div className="md:flex md:justify-between">
                    <div className="my-6">
                        <a href="/" className="flex items-center">
                            <img src="./logo.png" className="h-10 w-auto mr-1" alt=" Logo" />
                ...
                <div>
                    ...
                    {/* <div className="mt-4 text-lg mb-3 space-y-3">
                        ...
                        <p>Email: <span className="text-[#fd961a]">support@DELIGHTASSETMARKET.online</span></p>
                    </div> */}
                </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex my-10 sm:justify-center sm:mt-0">
                        <a href="#" className="text-[#007bff] hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-4 h-4 text-[#007bff]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                            </svg>
                            <span className="sr-only text-white">Facebook</span>
                        </a>
                        <a href="#" className=" text-[#007bff] hover:text-gray-900 dark:hover:text-white ms-5">
                            ...
                            <span className="sr-only text-white">Discord community</span>
                        </a>
                        <a href="#" className="text-[#007bff] hover:text-gray-900 dark:hover:text-white ms-5">
