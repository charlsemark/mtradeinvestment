    ...
    >
      <div className="container flex md:flex-row items-center justify-between flex-col">
        ...
        <div className="px-6 flex flex-col items-center justify-center text-center">
          <h1
            className="text-xl md:text-3xl lg:text-3xl font-bold mb-5 lg:mb-6 text-[#01123c] -tracking-wide md:w-3/4 lg:3/5"
            // data-aos="fade-up"
            // data-aos-delay="400"
          >
          ...
          <button
            className="flex items-center space-x-1 bg-[#01123c] text-white text-[16px] px-5 py-3 hover:opacity-80 ease-in duration-200 rounded-md"
            // data-aos="fade-up"
            // data-aos-delay="800"
          >
