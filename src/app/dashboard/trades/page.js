...
import CopyTradesComp from "@/components/DashboardComponents/CopyTraders"
    ...
    return (
        <>
            <div className="flex bg-white">
                ...
                {/* Main Component */}
                <div className="relative right-0 flex flex-2 flex-col gap-8 border border-l-0 border-t-0 border-r-1 w-full md:flex-1 left-0 md:left-[220px] overflow-scroll customized_scroll px-2 h-screen">
                    <CopyTradesComp />
                </div>
            </div>
        </>
